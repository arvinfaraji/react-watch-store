...
function BlogCard({cardClassName, timeToRead, watchBrand, title, writtenBy}) {
    return (
        <article className={cardClassName}>
            <div className="card__info-hover">
                ...
                <div className="card__clock-info">
                    ...
                    </svg><span className="card__time">{timeToRead}</span>
                </div>
            ...
            <div className="card__info">
                <span className="card__category"> {watchBrand}</span>
                <h3 className="card__title">{title}</h3>
                <span className="card__by">نوشته شده توسط <a href="#" className="card__author" title="author">{writtenBy}</a></span>
            </div>
        </article>
    )
}
